        ...
        reader.onload = (event) => {
            ...
            setTimeout(() => {
                setAnalysisResult({
                    grade: "18.5 / 20",
                    status: "Validated",
                    terms: ["Atelier", "Ã‰quipement", "Maintenance"],
    ...
    return (
        <div style={{ 
            ...
            <div style={{ flex: '1.5', background: '#f8fafc', borderRadius: '12px', padding: '15px', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', border: '2px dashed #cbd5e1' }}>
                {imgData ? (
                    <div style={{ width: '100%' }}>
                        <p style={{ fontSize: '10px', fontWeight: 'bold', color: '#2563eb', marginBottom: '10px', textAlign: 'center' }}>PROUVE DE L'Ã‰VALUATION (EVIDENCE)</p>
                        <img 
                            src={imgData} 
