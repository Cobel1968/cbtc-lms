...
import StudentHandwritingUpload from '@/components/StudentHandwritingUpload'; // Feature 4 Integration
...
export default function CoursesPage() {
  ...
  const quickAccessModules = [
    {
      id: 'voc-hospitality',
      name: { en: 'Hospitality Communication', fr: 'Communication HÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â´tellerie' },
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-blue-100">
            {language === 'fr' 
              ? 'Logiciel de pÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©dagogie pour la formation professionnelle bilingue'
        ...
        <div className="max-w-4xl mx-auto bg-blue-50 border border-blue-100 rounded-3xl p-8 flex flex-col md:flex-row items-center gap-8">
          <div className="flex-1 text-center md:text-left">
            <h2 className="text-2xl font-bold text-blue-900 mb-3 flex items-center justify-center md:justify-start gap-2">
              ...
              {language === 'fr' ? 'ÃƒÆ’Ã†â€™ÃƒÂ¢Ã¢â€šÂ¬Ã‚Â°valuation Manuscrite' : 'Handwriting Assessment'}
            </h2>
            <p className="text-blue-700 text-sm">
              {language === 'fr' 
                ? 'Utilisez l\'IA Cobel pour convertir vos ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©valuations physiques en donnÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©es de progression bilingue.'
                : 'Use Cobel AI to convert physical assessments into bilingual progression data.'}
            </p>
          </div>
          <div className="flex-shrink-0">
            <StudentHandwritingUpload />
          </div>
        </div>
      </section>
      ...
      <section className="bg-white shadow-sm border-b mt-16 sticky top-0 z-10">
        <div className="container mx-auto px-4 py-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            >
              <option value="all">{language === 'fr' ? 'Toutes catÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©gories' : 'All categories'}</option>
            ...
            >
              ...
              <option value="beginner">{language === 'fr' ? 'DÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©butant' : 'Beginner'}</option>
              <option value="intermediate">{language === 'fr' ? 'IntermÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©diaire' : 'Intermediate'}</option>
              <option value="advanced">{language === 'fr' ? 'AvancÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©' : 'Advanced'}</option>
            </select>
            ...
            >
              ...
              <option value="rating">{language === 'fr' ? 'Mieux notÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s' : 'Highest rated'}</option>
            </select>
          </div>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          ...
          <p className="text-gray-600 italic">
            {filteredAndSortedCourses.length} {language === 'fr' ? 'modules trouvÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â©s' : 'modules found'}
          </p>
        </div>
