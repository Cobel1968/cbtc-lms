      ...
      <div className="flex-1 p-10">
        <header className="mb-12">
          <h1 className="text-4xl font-black text-slate-900 uppercase italic">
            Global Readiness Test
          </h1>
          <p className="text-[#00629B] font-bold text-xs tracking-widest uppercase mt-2">
            Final Integration Audit // Cobel AI Engine
          </p>
        </header>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white p-8 rounded-[3rem] shadow-xl border-t-8 border-blue-500">
            ...
            <p className="text-4xl font-black my-2">
              {readinessData.linguistic.score}%
            </p>
        ...
        <div className="mt-12 bg-slate-900 rounded-[3rem] p-12 text-white shadow-2xl relative overflow-hidden">
          <div className="relative z-10">
            <h2 className="text-xs font-black text-blue-400 uppercase tracking-widest mb-4">
              Adaptive HTML Injection Triggered
            </h2>
            <p className="text-2xl font-light max-w-2xl leading-relaxed">
              ...
              , the student lacks complex sentence structures.
              <span className="text-blue-400 font-bold">
                {" "}
                Injecting: Technical Report Writing Module (Module 6){" "}
              </span>
