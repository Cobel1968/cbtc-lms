  ...
  const t = {
    ...
    mission: {
      ...
      description: language === 'fr'
        ? 'Offrir des formations de qualité supérieure qui transforment les carrières et développent les compétences professionnelles en Côte d\'Ivoire et en Afrique.'
        : 'Provide superior quality training that transforms careers and develops professional skills in Côte d\'Ivoire and Africa.',
    },
    vision: {
      title: language === 'fr' ? 'Notre Vision' : 'Our Vision',
      description: language === 'fr'
        ? 'Devenir la référence en matière de formation professionnelle en ligne en Afrique de l\'Ouest, en offrant des programmes innovants et accessibles.'
    ...
    values: {
      ...
      items: language === 'fr' 
        ? ['Excellence', 'Innovation', 'Accessibilité', 'Intégrité', 'Engagement']
      ...
      <section className="container mx-auto px-4 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-16">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            ...
            <p className="text-gray-600">{t.stats.courses}</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <Award className="mx-auto text-blue-600 mb-4" size={48} />
            <h3 className="text-3xl font-bold text-gray-900 mb-2">15+</h3>
            <p className="text-gray-600">{t.stats.instructors}</p>
          </div>
          <div className="bg-white rounded-lg shadow-md p-6 text-center">
            <Target className="mx-auto text-blue-600 mb-4" size={48} />
            <h3 className="text-3xl font-bold text-gray-900 mb-2">98%</h3>
            <p className="text-gray-600">{t.stats.satisfaction}</p>
          </div>
        </div>
