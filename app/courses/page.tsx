...
import { Search, Filter, BookOpen, Users, Clock, Star, ChevronRight } from 'lucide-react';
import { coursesData, getCoursesByCategory, getCoursesByLevel, sortCourses } from '../lib/courses-data';
        ...
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-blue-100">
            {language === 'fr' 
              ...
              : 'Discover our complete catalog of professional training courses'}
          </p>
        </div>
      </section>
      ...
      <section className="container mx-auto px-4 py-12">
        <div className="flex justify-between items-center mb-8">
          ...
          <p className="text-gray-600">
            {filteredAndSortedCourses.length} {language === 'fr' ? 'formations disponibles' : 'courses available'}
          </p>
        </div>
